...
namespace AzureStorageBlobPlayArea.Services
{
    public class ImageStorageService
    {
        ...
        {
            var credentials = new StorageCredentials("botteststorage1", "2Bt8LgFrsUBPyrd/9BaU+X0fNZ/mxQ5/tOEWqlaqI1CEu+hfJOaOMOqo7afK6vWr3U+PF6CK7H7aTUpTgxwOMg==");
        ...
        public Uri GetResourceUriWithSas(string resourceId)
        {
            ...
            return new Uri(_blobServiceEndpoint, $"/private-images/{resourceId}{sasToken}.ToString()");
